...
mainApp.service('PageInfoService', function($http, $location, $timeout, $q) {
    ...
    this.save = function(pageInfo) {
        ...
        this.updateDL = function(selectedData, reqParam, dataLayerId, dataLayerName, projectId) {

            var data = { 'dataLayer': selectedData, 'reqParamKeyVal': reqParam, 'dataLayerId': dataLayerId, 'dataLayerName': dataLayerName, 'projectId': projectId }
            $http.post("/api/updateDataLayer", data)

            ...
            .then(function(getDLsresponse) {
                ...
                if(dataLayerdata){
                    ...
                    for(i=0;i<dataLayerdata.length;i++){
                        ...
                        $http.post("http://" + host + ":" + port + "/" +"ITAG_POC/saveITagData", { 'dataLayer':copiedDL,'reqParamKeyVal':reqParamKeyVal,'projectId':copiedProjectId,'dataLayerName':dataLayerName})
                            .then(function(response) {

    ...
    mainApp.controller('homeController', function($scope, $http, PageInfoService, $localStorage, $location) {
        ...
        if ($scope.dataLayerName) {
            ...
            $http.get("/api/projects/" + $scope.projectId)
                .success(function(data, status, headers, response) {
                    ...
                    $scope.digitalData.page.pageInfo.country = data.country;
        ...
        $scope.saveDetails = function() {
                ...
                if ($routeParams.dataLayerId != undefined) {
                    ...
                    $scope.data = {
                        ...
                        'reqParamKeyVal': $scope.reqParam,
                        'projectId': $scope.projectId,
                        'dataLayerName': $scope.dataLayerName
                    }
